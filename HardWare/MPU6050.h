...
#define MPU_IIC_Init		  	MPU6050IIC_GPIO_Init
#define MPU_IIC_Start			  MPU6050IIC_Start
#define MPU_IIC_Stop			  MPU6050IIC_Stop
#define MPU_IIC_Send_Byte		MPU6050IIC_Send_Byte
#define MPU_IIC_Read_Byte		MPU6050IIC_Read_Byte
#define MPU_IIC_Wait_Ack		MPU6050IIC_Wait_Ack
